                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Edit Data Meja</h1>
                                    </div>
                                    @if ($errors->any())
                                    ...
                                    @endif
                                    <form method="POST" action="{{ route('meja.update', $meja->meja_id) }}" class="user">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-group">
                                            <label for="nomor_meja">Nomor Meja:</label>
                                            <input type="text" class="form-control form-control-user" id="nomor_meja" name="nomor_meja" value="{{ $meja->nomor_meja }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="kapasitas">Kapasitas:</label>
                                            <input type="text" class="form-control form-control-user" id="kapasitas" name="kapasitas" value="{{ $meja->kapasitas }}">
                                        </div>
                                        <div class="form-group">
